...
void main() {
  testWidgets('perfil detalhado cabe no celular e abre a foto', (tester) async {
    ...
    await tester.pumpWidget(MaterialApp(home: PerfilParticipante(
      participante: ParticipanteDaResenha(publicoId: '1', nome: 'Ana',
        pedidos: 1, pedidosTocados: 1, mediaAvaliacoes: 5,
        musicasMaisPedidas: const [MusicaMaisPedida(musica: 'Evidências', quantidade: 1)],
        avaliacoes: [AvaliacaoNaResenha(musica: 'Evidências', estrelas: 5,
    ...
    expect(tester.takeException(), anyOf(isNull, isA<NetworkImageLoadException>()));
  });
}
